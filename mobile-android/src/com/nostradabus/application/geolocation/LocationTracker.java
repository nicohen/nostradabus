...
public class LocationTracker extends Service implements LocationListener {
	...
	private class LocationHandler implements Runnable {
		...
		private String postLocation(Location location) throws Exception {
			Log.d(TAG, "postLocation=" + printShortLocation(location));
			ApiService.sendCheckpoint(1, location.getLatitude(), location.getLongitude(), 
					new Date(location.getTime()), location.getSpeed(), 53);
			return "";
		}
